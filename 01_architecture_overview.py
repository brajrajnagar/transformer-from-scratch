...
def explain_position_encoding():
    ...
    print("-" * 70)
    print()
    print("  'pos' = the POSITION of the token in the sequence")
    print("    Example: 'The' is at position 0, 'cat' is at position 1,")
    print("             'sat' is at position 2")
    print()
    print("  'i' = the DIMENSION INDEX (which coordinate we're computing)")
    print("    d_model = 8, so i goes from 0 to 3 (since d_model/2 = 4)")
    print()
    print("  '2i' and '2i+1' = pairs of dimensions")
    print("    Dimension 0 and 1 form a PAIR (i=0)")
    print("    Dimension 2 and 3 form a PAIR (i=1)")
    print("    Dimension 4 and 5 form a PAIR (i=2)")
    print("    Dimension 6 and 7 form a PAIR (i=3)")
    print()

    # Concrete example with numbers
    print("CONCRETE EXAMPLE:")
    print("  Sentence: 'The cat sat'  (3 tokens)")
    print("  d_model = 8  (each embedding has 8 numbers)")
    print()
    print("  For 'The' (position 0), we compute 8 numbers:")
    print()
    print("    Dim 0: sin(0 / 10000^0)   = sin(0)         =  0.00")
    print("    Dim 1: cos(0 / 10000^0)   = cos(0)         =  1.00")
    print("    Dim 2: sin(0 / 10000^0.25)= sin(0)         =  0.00")
    print("    Dim 3: cos(0 / 10000^0.25)= cos(0)         =  1.00")
    print("    Dim 4: sin(0 / 10000^0.5) = sin(0)         =  0.00")
    print("    Dim 5: cos(0 / 10000^0.5) = cos(0)         =  1.00")
    print("    Dim 6: sin(0 / 10000^0.75)= sin(0)         =  0.00")
    print("    Dim 7: cos(0 / 10000^0.75)= cos(0)         =  1.00")
    print()
    print("  For 'cat' (position 1), we compute 8 DIFFERENT numbers:")
    print()
    print("    Dim 0: sin(1 / 10000^0)   = sin(1)         =  0.84")
    print("    Dim 1: cos(1 / 10000^0)   = cos(1)         =  0.54")
    print("    Dim 2: sin(1 / 10000^0.25)= sin(0.32)      =  0.31")
    print("    Dim 3: cos(1 / 10000^0.25)= cos(0.32)      =  0.95")
    print("    Dim 4: sin(1 / 10000^0.5) = sin(0.01)      =  0.01")
    print("    Dim 5: cos(1 / 10000^0.5) = cos(0.01)      =  1.00")
    print("    Dim 6: sin(1 / 10000^0.75)= sin(0.00)      =  0.00")
    print("    Dim 7: cos(1 / 10000^0.75)= cos(0.00)      =  1.00")
    print()
    print("  For 'sat' (position 2), the values shift even more:")
    print()
    print("    Dim 0: sin(2 / 10000^0)   = sin(2)         =  0.91")
    print("    Dim 1: cos(2 / 10000^0)   = cos(2)         = -0.42")
    print("    Dim 2: sin(2 / 10000^0.25)= sin(0.63)      =  0.59")
    print("    Dim 3: cos(2 / 10000^0.25)= cos(0.63)      =  0.81")
    print("    Dim 4: sin(2 / 10000^0.5) = sin(0.02)      =  0.02")
    print("    Dim 5: cos(2 / 10000^0.5) = cos(0.02)      =  1.00")
    print("    Dim 6: sin(2 / 10000^0.75)= sin(0.00)      =  0.00")
    print("    Dim 7: cos(2 / 10000^0.75)= cos(0.00)      =  1.00")
    print()
    print("Notice: Each position gets a UNIQUE combination of sin/cos values.")
    print("The later dimensions change SLOWER (they capture long-range patterns).")
    print("The earlier dimensions change FASTER (they capture fine details).")
    print()
